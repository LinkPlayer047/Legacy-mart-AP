...
const Sidebar = ({ children }) => {
  ...
  return (
    <div className="flex h-screen">
          ...
          {menuItems.map((items) => {
            ...
            return (
              ...
              ${active ? "bg-white shadow-lg" : ""}`}>
                ...
                {!collapsed && <span className="font-medium text-black hover:text-blue-500">{items.name}</span>}
              </Link>
            )
          })}        
        </nav>
      ...
      <button id="sidebar-toggle" className="m-4 py-2 px-3 bg-white text-black hover:bg-blue-500/20 hover:text-blue-500 rounded md:hidden"
